...
# MODEL_PATH = DATA_DIR / "models" / "logisticregression_5s_50pct_purity80.joblib"
MODEL_PATH = DATA_DIR / "models" / f"logreg_pipe_{TAG}.joblib"
...
if mode == "Minimal":
    ...
    show_status_banner(is_rushing=(last_status == 1), personalized=True)
